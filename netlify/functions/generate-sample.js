...
exports.handler = async (event) => {
  ...
  try {
	...
	// Try to still redirect the user to the sample page even if email fails
	const fallbackRedirect = `https://restaurantreviewcards.com/sample.html?name=${encodeURIComponent(submittedName)}&rating=N/A&reviews=0&placeId=${placeId}&email=${encodeURIComponent(email)}&error=details_fetch_failed`;
